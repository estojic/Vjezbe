function ljubav(ime1, ime2){
	...
	if ((ime1.trim().toLowerCase()=="luka" && ime2.trim().toLowerCase()=="ivana") 
		|| (ime2.trim().toLowerCase()=="luka" && ime1.trim().toLowerCase()=="ivana")){
			return 99;
		}


	if ((ime1.trim().toLowerCase()=="css" && ime2.trim().toLowerCase()=="html") 
		|| (ime2.trim().toLowerCase()=="css" && ime1.trim().toLowerCase()=="html")){
			return 99;
		}
